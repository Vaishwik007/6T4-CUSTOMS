          ...
          <div className="embla__container gap-4">
            {FEATURED_BUILDS.map((b, i) => (
              <motion.article
                ...
                data-cursor="cta"
              >
                {/* faux bike imagery via gradient + grid */}
                <div className="relative aspect-[4/3] w-full overflow-hidden bg-gradient-to-br from-gunmetal to-black">
                  ...
                  <div className="absolute right-3 top-3 inline-flex items-center gap-1 bg-neon px-2 py-1 text-[10px] font-bold uppercase tracking-widest text-black">
                ...
                <div className="p-6">
                  ...
                  <h3 className="mt-2 text-display text-2xl font-bold uppercase text-bone">
                    {b.title}
                  </h3>
